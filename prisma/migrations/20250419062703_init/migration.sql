-- CreateEnum
CREATE TYPE "Platform" AS ENUM ('YOUTUBE', 'TWITCH', 'KICK', 'TWITCASTING');
...
-- CreateIndex
CREATE UNIQUE INDEX "Streamer_platform_platformId_key" ON "Streamer"("platform", "platformId");

-- CreateIndex
CREATE UNIQUE INDEX "DictionaryEntry_term_key" ON "DictionaryEntry"("term");
...
-- AddForeignKey
ALTER TABLE "DictionaryEntry" ADD CONSTRAINT "DictionaryEntry_authorId_fkey" FOREIGN KEY ("authorId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
